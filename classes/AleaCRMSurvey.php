...
?>
        ...
        {
        ?>
            <div class="flex"><input type="hidden" name="state" value="1"></div>
            <div class="flex-col flex-wrap bg-gray-100 rounded-xl shadow-xl space-y-4 p-4">

                <input type="hidden" name="id" value="<?= $customer->getId(); ?>" />
                <?php if ($customer->getId() != 0 || $customer->getId() != null) : ?>
