...
?>
    ...
    <div class="flex-row">
        <fieldset>
            <label><input required type="radio" name="ultima_analitica" value="1" <?= ($survey->getultima_analitica() == 1) ? "checked" : ""; ?>>Si</label>
            <label><input required type="radio" name="ultima_analitica" value="2" <?= ($survey->getultima_analitica() == 2) ? "checked" : ""; ?>>No</label>
        </fieldset>
    </div>
